...
listen_friend_names = '大学 宁子豪'  # 需要监听的人名称
listen_friend_groups = 'No name'  # 在这些群里监听好友说的话


# 转发信息至群
is_forward_mode = False  # 打开转发模式
forward_groups = 'No name'  # 需要将消息转发的群，匹配模式同上

# 群分享监控
is_listen_sharing = False
listen_sharing_groups = 'No name'  # 监控群分享，匹配模式同上
